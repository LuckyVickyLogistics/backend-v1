...
public class UserController {
	...
	// 내 정보 조회
	@GetMapping("/me")
	public ResponseEntity<ApiResponse<UserDetailResponse>> getMyInfo(HttpServletRequest request) {
		UserDetailResponse myInfo = userService.getMyInfo(request);
	...
	public ResponseEntity<ApiResponse<Void>> updateUser(
		...
		return ResponseEntity.ok(ApiResponse.success("회원 정보를 수정했습니다."));
	}
	...
	public ResponseEntity<ApiResponse<Void>> deactiveUser(@PathVariable Long userId) {
		userService.deactiveUser(UserDeactiveCommand.builder().userId(userId).build());
