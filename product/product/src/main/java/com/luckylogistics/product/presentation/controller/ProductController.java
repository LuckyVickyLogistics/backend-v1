...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse<ProductResponse>> updateProduct(@Valid @PathVariable(name = "productId") UUID productId, @RequestBody ProductRequest productRequest) {
    ...
    public ResponseEntity<ApiResponse<Boolean>> deleteProduct(@Valid @PathVariable UUID productId) {
    ...
    public ResponseEntity<ApiResponse<Boolean>> rollbackProducts(@Valid @PathVariable UUID productId) {
    ...
    public ResponseEntity<ApiResponse<Boolean>> hiddenProducts(@Valid @PathVariable UUID productId) {
    ...
    public ResponseEntity<ApiResponse<Boolean>> minusProducts(@Valid @PathVariable UUID productId, @RequestBody MinusRequest request) {
    ...
    public ResponseEntity<ApiResponse<Boolean>> plusProducts(@Valid @PathVariable UUID productId, @RequestBody PlusRequest request) {
